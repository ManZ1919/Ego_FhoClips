...
_C.DATA.VIDEO_DIR_PATH = "/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/full_scale"

# Path to keystep localisation annotations
_C.DATA.ANN_PATH = "/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/annotations/fho_oscc-pnr_train.json"
# /media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/full_scale
# Path to the directory containing annotation json files
_C.DATA.ANN_DIR = "/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/annotations"

# Path to keystep localisation splits
# _C.DATA.SPLIT_PATH = ("/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/annotations/splits.json")

_C.DATA.SPLIT_PATH = "/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/annotations/fho_oscc-pnr_train.json"

# Path to directory for temporarily or permanentaly storing clipped videos
_C.DATA.CLIPS_SAVE_PATH = "/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/positive_clips"

# Path to directory containing no-state change videos
_C.DATA.NO_SC_PATH = "/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/negative_clips"

# Path to the no state change clips splits
# _C.DATA.NO_SC_SPLIT_PATH = ("/home/sid/Ego4D_keyframe_localisation/"
#                             "no_sc_splits.json")
_C.DATA.NO_SC_SPLIT_PATH = "/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/annotations/fho_oscc" \
                           "-pnr_test_unannotated.json "
...
_C.DATA.TASK = "state_change_detection_and_keyframe_localization"
...
# Path to json file contai  ning details about clipping of test and validation
...
_C.JSON_EXPORT.SAVE_DIR = '/media/dml/e5afa40a-df1a-4c60-8623-87e2a51c3a09/ego4d/new/v1/clips'
